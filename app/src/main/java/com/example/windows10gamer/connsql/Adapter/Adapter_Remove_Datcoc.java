...
import com.example.windows10gamer.connsql.Remove_Data.Main_Remove_Datcoc;
...
public class Adapter_Remove_Datcoc extends ArrayAdapter<Datcoc> {

    List<Datcoc> contactList;
    Main_Remove_Datcoc context;
    private LayoutInflater mInflater;

    // Constructors
    public Adapter_Remove_Datcoc(Main_Remove_Datcoc context, List<Datcoc> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Datcoc item = getItem(position);
