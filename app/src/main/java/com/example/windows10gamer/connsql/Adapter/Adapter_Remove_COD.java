...
public class Adapter_Remove_COD extends ArrayAdapter<PhiCOD> {

    List<PhiCOD> contactList;
    Main_Remove_COD context;
    private LayoutInflater mInflater;

    // Constructors
    public Adapter_Remove_COD(Main_Remove_COD context, List<PhiCOD> objects) {
    ...
    @Override
    public PhiCOD getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final PhiCOD item = getItem(position);
