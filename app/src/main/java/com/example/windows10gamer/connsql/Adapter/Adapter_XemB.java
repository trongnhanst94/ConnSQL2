...
import com.example.windows10gamer.connsql.Kiem_Kho.Main_Kiemkho_XemB;
...
/**
 * Created by EVRESTnhan on 11/18/2017.
 */

public class Adapter_XemB extends BaseAdapter implements Serializable, Filterable{
    private Main_Kiemkho_XemB context;
    private ArrayList<Sanpham_ID> sanphams;
    CustomFilter filter;
    ArrayList<Sanpham_ID> filterList;
    private int layout;

    public Adapter_XemB(Main_Kiemkho_XemB context, int layout, ArrayList<Sanpham_ID> sanphams) {
