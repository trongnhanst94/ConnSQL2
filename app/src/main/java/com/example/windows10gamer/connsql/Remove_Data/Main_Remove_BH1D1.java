...
public class Main_Remove_BH1D1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_remove_bh1d1);
        shared = getSharedPreferences("chinhanh", MODE_PRIVATE);
        chinhanh = shared.getString("chinhanh", "");
        ed = findViewById(R.id.ed);
        list = findViewById(R.id.list);
        btn = findViewById(R.id.btn);
        adapter = new Adapter_Remove_Baohanh(Main_Remove_BH1D1.this, R.layout.adapter_dele_baohanh, contactList);
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT == 24) {
                    final Context contextThemeWrapper =
                            new ContextThemeWrapper(Main_Remove_BH1D1.this, android.R.style.Theme_Holo_Light_Dialog);
                    try {
                    ...
                    DatePickerDialog datePickerDialog = new DatePickerDialog(Main_Remove_BH1D1.this, android.R.style.Theme_Holo_Light_Panel, new DatePickerDialog.OnDateSetListener() {
                        @Override
                        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                            calendar.set(year, month, dayOfMonth);
                            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd-MM-yyyy");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ngay.equals("")){
                    Toasty.warning(Main_Remove_BH1D1.this, "Chưa chọn ngày", Toast.LENGTH_LONG, true).show();
                } else {
                    new SendRequest().execute();
                }
            }
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                if(!Connect_Internet.checkConnection(getApplicationContext()))
                    Connect_Internet.buildDialog(Main_Remove_BH1D1.this).show();
                else {
                    AlertDialog.Builder builder = null;
                    if(Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
                        builder = new AlertDialog.Builder(Main_Remove_BH1D1.this);
                    } else {
                        builder = new AlertDialog.Builder(Main_Remove_BH1D1.this, android.R.style.Theme_Holo_Light_Panel);
                    }
    ...
    public class SendRequest extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            dialog = new ProgressDialog(Main_Remove_BH1D1.this);
    ...
    class GetDonhang extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            JSONObject jsonObject = JSONParser.getDataFromWeb(Keys.MAIN_BH_BH1DOI1+"?delengay="+ngay);
            try {
                if (jsonObject != null) {
                    contactList.clear();
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (contactList.size() > 0){
                ...
                Toasty.info(Main_Remove_BH1D1.this, "Không có đơn hàng nào", Toast.LENGTH_LONG, true).show();
            dialog.dismiss();
        }
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Keys.LINK_WEB_V2,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")){
                            new SendRequest().execute();
                            Toasty.success(Main_Remove_BH1D1.this, "Xóa thành công", Toast.LENGTH_LONG, true).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toasty.error(Main_Remove_BH1D1.this, "Không kết nối được Server", Toast.LENGTH_LONG, true).show();
                    }
                }
        ){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("tacvu", Keys.DELE_BH1D1_WEB);
                params.put("id", id);
                return params;
            }
        };
