...
import com.example.windows10gamer.connsql.Remove_Data.Main_Remove_Order;
...
public class Adapter_Remove_Order extends ArrayAdapter<Order> {

    List<Order> contactList;
    Main_Remove_Order context;
    private LayoutInflater mInflater;

    // Constructors
    public Adapter_Remove_Order(Main_Remove_Order context, List<Order> objects) {
        ...
        vh.tvRLgio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               android.support.v7.app.AlertDialog.Builder builder = null;
                ...
                builder.setMessage("Bạn muốn xóa đơn hàng lúc "+item.getGio()+"?");
