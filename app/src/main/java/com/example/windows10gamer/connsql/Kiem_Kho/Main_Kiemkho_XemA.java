...
public class Main_Kiemkho_XemA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.lvXemA);
        adapter = new Adapter_XemA(Main_Kiemkho_XemA.this,R.layout.adapter_xem, sanphams);
        listView.setAdapter(adapter);
        searchView = (EditText) findViewById(R.id.svSearchItemXemA);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Keys.LINK_WEB,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("error")){
                            new CustomToast().Show_Toast(Main_Kiemkho_XemA.this, findViewById(android.R.id.content), "Lỗi ");
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        new CustomToast().Show_Toast(Main_Kiemkho_XemA.this, findViewById(android.R.id.content), "Lỗi "+error);
                    }
                }
        ){
            @Override
    ...
    class GetDataKho extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void string) {
            ...
            if(sanphams.size() > 0) {
                ...
                new CustomToast().Show_Toast(Main_Kiemkho_XemA.this, findViewById(android.R.id.content), "Không có dữ liệu!!");
            }
            dialog.dismiss();
        }
    }
