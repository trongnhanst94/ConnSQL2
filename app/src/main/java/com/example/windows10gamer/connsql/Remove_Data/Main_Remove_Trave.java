...
public class Main_Remove_Trave extends AppCompatActivity {
    ...
    ArrayList<TienTraVe> contactList = new ArrayList<>();
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT == 24) {
                    final Context contextThemeWrapper =
                            new ContextThemeWrapper(Main_Remove_Trave.this, android.R.style.Theme_Holo_Light_Dialog);
                    try {
                    ...
                    DatePickerDialog datePickerDialog = new DatePickerDialog(Main_Remove_Trave.this, android.R.style.Theme_Holo_Light_Panel, new DatePickerDialog.OnDateSetListener() {
                        @Override
                        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                            calendar.set(year, month, dayOfMonth);
                            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd-MM-yyyy");
    ...
    public class SendRequest extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            dialog = new ProgressDialog(Main_Remove_Trave.this);
        ...
        protected String doInBackground(Void... arg0) {
            if(!Connect_Internet.checkConnection(getApplicationContext()))
                Connect_Internet.buildDialog(Main_Remove_Trave.this).show();
            else {
                new Main_Remove_Trave.GetDatcoc().execute(chinhanh);
            }
            return null;
        }
