...
public class Main_Remove_Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRmOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ngay.equals("")){
                    new CustomToast().Show_Toast(Main_Remove_Order.this,findViewById(android.R.id.content), "Chưa chọn ngày!");
                } else {
    ...
    class GetDonhang extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            } else new CustomToast().Show_Toast(Main_Remove_Order.this, findViewById(android.R.id.content), "Không có đơn hàng!");
            dialog.dismiss();
        }
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Keys.LINK_WEB_V2,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")){
                            new SendRequest().execute();
                            new CustomToast().Show_Toast(Main_Remove_Order.this, findViewById(android.R.id.content), "Xóa thành công!");
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        new CustomToast().Show_Toast(Main_Remove_Order.this, findViewById(android.R.id.content), "Không kết nối được Server!");
                    }
                }
        ){
            @Override
