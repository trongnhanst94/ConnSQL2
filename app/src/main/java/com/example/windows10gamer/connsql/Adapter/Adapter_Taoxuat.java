...
import com.example.windows10gamer.connsql.Xuat_Nhap.Main_Taoxuat;
...
public class Adapter_Taoxuat extends BaseAdapter implements Serializable{
    private Main_Taoxuat context;
    private List<Sanpham_gio> sanphams;
    private int layout;

    public Adapter_Taoxuat(Main_Taoxuat context, int layout, List<Sanpham_gio> sanphams) {
