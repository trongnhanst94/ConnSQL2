...
public class Adapter_KiemKho extends BaseAdapter implements Serializable{
    private Main_Kiemkho context;
    private List<SanphamAmount> sanphams;
    private int layout;
    private List<String> strings;

    public Adapter_KiemKho(Main_Kiemkho context, int layout, List<SanphamAmount> sanphams, List<String> strings) {
