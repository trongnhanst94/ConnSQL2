...
public class Adapter_Report_BHDDT extends BaseAdapter{
    private Context context;
    private List<BHDDT> list;
    private int layout;

    public Adapter_Report_BHDDT(Context context, int layout, List<BHDDT> list) {
