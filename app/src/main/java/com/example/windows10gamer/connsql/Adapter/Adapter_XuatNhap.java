...
public class Adapter_XuatNhap extends BaseAdapter{

    Context context;
    int layout;
    List<XuatNhap_SL> list;

    public Adapter_XuatNhap(Context context, int layout, List<XuatNhap_SL> list) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        holder.tvchinhanhNhan.setText(Keys.trimChinhanh(xuatNhap.getChinhanhToday())+ " → "+ Keys.trimChinhanh(xuatNhap.getChinhanhNhan()));
        if (phantram < 50){
    ...
    private class ViewHolder{
        TextView tvchinhanhNhan, tvsoluong, tvngayXuat, tvnguoiXuat;
    }
}
